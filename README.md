...
<ul>
  ...
  <li>Конструктор копирования принимает объект того же класса <code>Point</code> и устанавливает через сетеры значения координат из переданного объекта.</li>
...
<ul>
  ...
  <li>В <code>main</code>:
    <ul>
      ...
      <li>линия 3 создаётся с использованием <strong>тех же объектов</strong> <code>Point</code> из линий 1 и 2 (точка начала - начало линии 1, точка конца - конец линнии 2);</li>
      ...
      <li>указание в сеттереры линий 1 и 2 объекта класса <code>Point</code> приводит к записи новой ссылки, в линии 3 ничего не меняется, тем самым линии описываются разными координатами.</li>
    </ul>
  </li>
</ul>
...
<ul>
  ...
  <li>Конструкторы:
    <ul>
      ...
      <li>копирующий оценки объекта того же класса — принимает имя, и <strong>создаёт новый массив</strong>, поэлементно копируя значения массива оценок предоваемого студента.</li>
    </ul>
  </li>
...
<p><strong>Алгоритм решения:</strong>
  <ul>
  <li>Описывается консруктор принимающий два объекта класса <code>Point</code>.</li>
